...
Namespace AnimateChangedRows
	Partial Public Class Window1
		...
		Private Function GetAnimationElement(ByVal listIndex As Integer) As AnimationElement
			Dim element As New AnimationElement()
			Dim flag As Boolean = animationElements.TryGetValue(listIndex, element)
			If Not flag Then
...
'INSTANT VB NOTE: The variable number was renamed since Visual Basic does not allow variables and other class members to have the same name:
		Private number_Renamed As Integer
'INSTANT VB NOTE: The variable text was renamed since Visual Basic does not allow variables and other class members to have the same name:
