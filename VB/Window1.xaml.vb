...
Namespace AnimateChangedRows
	...
	Partial Public Class Window1
		...
		Private Function GetAnimationElement(ByVal listIndex As Integer) As AnimationElement
            Dim element As AnimationElement = New AnimationElement()
	...
	Public Class AnimationElement
        ...
        Public Shared ReadOnly ColorProperty As DependencyProperty = _
            DependencyProperty.Register("Color", GetType(Color), _
            GetType(AnimationElement), New PropertyMetadata(Colors.White, _
            AddressOf OnChanged))

        Private Shared Sub OnChanged(ByVal d As DependencyObject, _
		...
		Public Sub StartAnimation()
            ...
            animation.KeyFrames.Add(New DiscreteColorKeyFrame(Color.FromArgb(255, 255, 255, 255), _
                KeyTime.FromTimeSpan(TimeSpan.FromSeconds(0))))
            animation.KeyFrames.Add(New LinearColorKeyFrame(Color.FromArgb(255, 200, 200, 200), _
                KeyTime.FromTimeSpan(TimeSpan.FromSeconds(1))))
            animation.KeyFrames.Add(New LinearColorKeyFrame(Color.FromArgb(255, 255, 255, 255), _
                KeyTime.FromTimeSpan(TimeSpan.FromSeconds(1.5))))

            Me.BeginAnimation(AnimationElement.ColorProperty, animation, _
